(module
 ...
 (data (i32.const 1560) "\01\00\00\00\08\00\00\00y\00e\00a\00r")
 (data (i32.const 1580) "<")
 (data (i32.const 1592) "\01\00\00\00$\00\00\00K\00e\00y\00 \00d\00o\00e\00s\00 \00n\00o\00t\00 \00e\00x\00i\00s\00t")
 (data (i32.const 1644) ",")
 (data (i32.const 1656) "\01\00\00\00\16\00\00\00~\00l\00i\00b\00/\00m\00a\00p\00.\00t\00s")
 (data (i32.const 1696) "\04\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1724) "\10\1a\82")
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18116))
 ...
 (func $~lib/map/Map<~lib/string/String,f64>#find (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/map/Map<~lib/string/String,f64>#set (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
